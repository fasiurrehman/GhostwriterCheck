...
option = st.selectbox("Please select one", ("Title to Abstract", "Topic to Abstract"))

st.write("You selected:", option)

if option == "Title to Abstract":
    title = st.text_input(
        "Please input the title of the paper. Five or more words are suggested for best results."
    )
